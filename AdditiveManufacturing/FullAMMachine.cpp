...
FullAMMachine::FullAMMachine(UA_Server *pServer) : FullAMMachine(pServer, true) {}

FullAMMachine::FullAMMachine(UA_Server *pServer, bool initialize)
  : InstantiatedAMMachine(pServer), JobStateMachine(mt.Production->ActiveProgram->State.value, pServer) {
  if (initialize) {
    MachineName = "FullAMMachine";
    CreateObject();
  }
}

void FullAMMachine::CreateObject() {
...
void FullAMMachine::InstantiateProduction() {
...
void FullAMMachine::InstantiateIdentification() {
  InstantiatedAMMachine::InstantiateIdentification();
  ...
  mt.Identification->Location = "AMB 10 A75/IMTS E3 134744/VIRTUAL 0 0/N 48.781340 E 9.165731";
...
void FullAMMachine::InstantiateTools() {
...
void FullAMMachine::InstantiateMonitoring() {
...
void FullAMMachine::InstantiatePrognosis() {
...
void FullAMMachine::Simulate() {
  ...
  if ((m_simStep % 10) == 8) {
    ...
    notification.SourceName = "FullAMMachine";
