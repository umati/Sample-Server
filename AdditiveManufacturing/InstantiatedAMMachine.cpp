...
void InstantiatedAMMachine::InstantiateIdentification() {
  {
    std::stringstream ss;
    ss << "http://www.additive-manufacturing.com/#" << MachineName;
...
void InstantiatedAMMachine::InstantiateMonitoringChannel(int numChannels) {
...
void InstantiatedAMMachine::InstantiateMonitoringMT() {
