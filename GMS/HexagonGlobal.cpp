...
void HexagonGlobal::CreateObject() {
  std::stringstream ss;
...
void HexagonGlobal::InstantiateIdentification() {
  {
    std::stringstream ss;
    ss << "https://www.hexagonmi.com/de-DE/products/coordinate-measuring-machines/bridge-cmms/global-s";
  ...
  mt.Identification->Location = "TECHNISHOW 10 E018/TMTS 4 G0912/VIRTUAL 1 1/N 48.6939789 E 9.1839305";
...
void HexagonGlobal::InstantiateTools() {
