...
void FullMachineTool::InstantiateProduction() {
  ...
  mt.Production->ActiveProgram->JobIdentifier.value = job.Identifier.value;
...
void FullMachineTool::InstantiateIdentification() {
  ...
  mt.Identification->Location = "CCMT 5 A219/GRIND 9 B20/VIRTUAL 1 1/N 48.781340 E 9.165731";
