...
REFL_TYPE(di::IVendorNameplate_t,
          UmatiServerLib::attribute::UaObjectType{
              .NodeId = UmatiServerLib::constexp::NodeId(constants::NsDIUri, UA_DIID_IVENDORNAMEPLATETYPE)})
...
REFL_FIELD(SoftwareRevision, UmatiServerLib::attribute::PlaceholderOptional(),
          UmatiServerLib::attribute::MemberInTypeNodeId{
              .NodeId = UmatiServerLib::constexp::NodeId(constants::NsDIUri, UA_DIID_IVENDORNAMEPLATETYPE_SOFTWAREREVISION)})
REFL_FIELD(Manufacturer, UmatiServerLib::attribute::PlaceholderOptional(),
          UmatiServerLib::attribute::MemberInTypeNodeId{
              .NodeId = UmatiServerLib::constexp::NodeId(constants::NsDIUri, UA_DIID_IVENDORNAMEPLATETYPE_MANUFACTURER)})
REFL_FIELD(SerialNumber, UmatiServerLib::attribute::PlaceholderOptional(),
          UmatiServerLib::attribute::MemberInTypeNodeId{
              .NodeId = UmatiServerLib::constexp::NodeId(constants::NsDIUri, UA_DIID_IVENDORNAMEPLATETYPE_SERIALNUMBER)})
REFL_FIELD(DeviceClass, UmatiServerLib::attribute::PlaceholderOptional(),
          UmatiServerLib::attribute::MemberInTypeNodeId{
              .NodeId = UmatiServerLib::constexp::NodeId(constants::NsDIUri, UA_DIID_IVENDORNAMEPLATETYPE_DEVICECLASS)})
REFL_END
