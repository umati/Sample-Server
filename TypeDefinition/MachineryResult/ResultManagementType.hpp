...
REFL_TYPE(
        ...
        REFL_FIELD(
                Results,
                UmatiServerLib::attribute::MemberInTypeNodeId(UmatiServerLib::constexp::NodeId(constants::NsMachineryResultUri, UA_MACHINERY_RESULTID_RESULTMANAGEMENTTYPE_RESULTS)),
                UmatiServerLib::attribute::PlaceholderOptional()
                )
REFL_END
