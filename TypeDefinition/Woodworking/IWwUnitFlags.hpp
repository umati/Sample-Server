...
REFL_FIELD(DustChipSuction,
           UmatiServerLib::attribute::PlaceholderOptional(),
           UmatiServerLib::attribute::MemberInTypeNodeId(UmatiServerLib::constexp::NodeId(constants::NsWoodworkingUri, UA_WOODWORKINGID_IWWUNITFLAGSTYPE_DUSTCHIPSUCTION))
)
...
REFL_FIELD(WorkpiecePresent,
           UmatiServerLib::attribute::PlaceholderOptional(),
           UmatiServerLib::attribute::MemberInTypeNodeId(UmatiServerLib::constexp::NodeId(constants::NsWoodworkingUri, UA_WOODWORKINGID_IWWUNITFLAGSTYPE_WORKPIECESPRESENT))
)
REFL_FIELD(Moving,
           UmatiServerLib::attribute::PlaceholderOptional(),
...
REFL_FIELD(ManualActivityRequired,
           UmatiServerLib::attribute::PlaceholderOptional(),
           UmatiServerLib::attribute::MemberInTypeNodeId(UmatiServerLib::constexp::NodeId(constants::NsWoodworkingUri, UA_WOODWORKINGID_IWWUNITFLAGSTYPE_MANUALACTIVITYREQUIRED))
)
REFL_FIELD(LoadingEnabled,
           UmatiServerLib::attribute::PlaceholderOptional(),
           UmatiServerLib::attribute::MemberInTypeNodeId(UmatiServerLib::constexp::NodeId(constants::NsWoodworkingUri, UA_WOODWORKINGID_IWWUNITFLAGSTYPE_LOADINGENABLED))
)
REFL_FIELD(WaitUnload,
           UmatiServerLib::attribute::PlaceholderOptional(),
...
REFL_FIELD(ExternalEmergency,
           UmatiServerLib::attribute::PlaceholderOptional(),
           UmatiServerLib::attribute::MemberInTypeNodeId(UmatiServerLib::constexp::NodeId(constants::NsWoodworkingUri, UA_WOODWORKINGID_IWWUNITFLAGSTYPE_EXTERNALEMERGENCY))
)
REFL_FIELD(MaintenanceRequired,
           UmatiServerLib::attribute::PlaceholderOptional(),
           UmatiServerLib::attribute::MemberInTypeNodeId(UmatiServerLib::constexp::NodeId(constants::NsWoodworkingUri, UA_WOODWORKINGID_IWWUNITFLAGSTYPE_MAINTENANCEREQUIRED))
)
REFL_FIELD(FeedRuns,
           UmatiServerLib::attribute::PlaceholderOptional(),
