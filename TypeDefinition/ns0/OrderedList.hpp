...
REFL_TEMPLATE((typename T), (ns0::OrderedList_t<T>),
              UmatiServerLib::attribute::UaObjectType(
                  UmatiServerLib::constexp::NodeId(constants::Ns0Uri, UA_NS0ID_ORDEREDLISTTYPE)))
REFL_FIELD(NodeVersion,
           UmatiServerLib::attribute::MemberInTypeNodeId(
               UmatiServerLib::constexp::NodeId(constants::Ns0Uri, UA_NS0ID_ORDEREDLISTTYPE_NODEVERSION)),
           UmatiServerLib::attribute::PlaceholderOptional())
REFL_FIELD(OrderedObjects,
           UmatiServerLib::attribute::MemberInTypeNodeId(
               UmatiServerLib::constexp::NodeId(constants::Ns0Uri, UA_NS0ID_ORDEREDLISTTYPE_ORDEREDOBJECT_PLACEHOLDER)),
           UmatiServerLib::attribute::PlaceholderOptional())
REFL_END
